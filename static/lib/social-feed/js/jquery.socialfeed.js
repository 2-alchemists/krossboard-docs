...
(function($, window, document, undefined) {
    ...
    $.fn.socialfeed = function(_options) {
        ...
        var defaults = {
            ...
            media_min_width: 300,
            length: 256, // maximum length of post message shown
            date_format: 'll'
        };
        //---------------------------------------------------------------------------------
            ...
            twitter: {
                ...
                utility: {
                    ...
                    unifyPostData: function(element) {
                        ...
                        if (element.id) {
                            post.id = element.id;
                            post.tpl_class = options.twitter.tpl_class;
                            post.tpl_class1 = options.twitter.tpl_class1;
                            post.tpl_class2 = options.twitter.tpl_class2;
                            post.tpl_class3 = options.twitter.tpl_class3;
                            post.tpl_class4 = options.twitter.tpl_class4;
                            ...
                            // Rgen changes
                            if (element.entities.user_mentions.length > 0) {
                                post.user_name = element.entities.user_mentions[0].name;
                                post.user_url = 'http://twitter.com/' + element.entities.user_mentions[0].screen_name;
                            }
                            // End - Rgen changes
            ...
            instagram: {
                ...
                getData: function(account) {
                    ...
                    switch (account[0]) {
                        ...
                        // Rgen changes
                        case '*':
                            var username = options.instagram.userdata;
                            url = Feed.instagram.api + 'users/search/?q=' + username + '&count=' + options.instagram.limit + '&' +  authTokenParams + '';
                            Utility.request(url, Feed.instagram.utility.getUsers);
                        // End - Rgen changes
                ...
                utility: {
                    ...
                    getUsers: function(json) {
                        ...
                        json.data.forEach(function(user) {
                            ...
                            // Rgen changes
                            if (user.username === options.instagram.userdata) {
                                Utility.request(url, Feed.instagram.utility.getImages);
                            }
                            // End - Rgen changes
                        });
                    ...
                    unifyPostData: function(element) {
                        var post = {};
                        post.tpl_class = options.instagram.tpl_class;
                        post.id = element.id;
                        post.comment = element.comments.count ? element.comments.count : 0;
                        post.likes = element.likes.count ? element.likes.count : 0;
